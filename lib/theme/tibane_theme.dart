...
/// used to color the chain name in lists so each chain is instantly legible on
/// the dark surfaces. Falls back to muted text for unknown chains.
Color chainColor(String chain) {
  switch (chain) {
    case 'solana':
      return TibaneColors.solana;
    case 'ethereum':

...
///
/// This is the Ellipx-parity custody layer (ported from
/// `ellipx/lib/service/biometric.dart`). The StoreKey private is stored behind
/// a per-read biometric gate via `biometric_storage`, keyed by the StoreKey's
/// **public key** (Ellipx convention: `setSecuredKey(priv, walletKey.key)`).
/// Reading it (`askSecuredKey`) triggers a FaceID / fingerprint prompt.
///
/// ## Storage-role split (Ellipx-parity migration, see ELLIPX_PARITY §3.1)
///
...
///
/// Deliberate deviation from Ellipx: Ellipx's [askSecuredKey] carries a
...
/// Mirrors Ellipx: biometrics are usable iff the hardware can check them AND
